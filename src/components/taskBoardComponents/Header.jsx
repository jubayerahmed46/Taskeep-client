function Header({ text, count }) {
  return (
    ...
    >
      {text}{" "}
      <span className="flex justify-center items-center bg-white dark:bg-transparent dark:text-primary rounded-full md:h-5 h-3 aspect-square sm:text-sm text-[8px] text-black">
        {count}
      </span>
    </div>
  );
